...
typedef enum{
	...
	Button_Bit_Shake,				//状态_抖动1
	Button_Bit_Press,				//状态_按下2
	Button_Bit_Long,				//状态_长按3
	//边沿状态
	Button_Bit_Drop,				//边沿_按下4
	Button_Bit_Rise,				//边沿_弹起5
	Button_Bit_LongDrop,		//边沿_长按按下6
	Button_Bit_LongRise,		//边沿_长按弹起7
